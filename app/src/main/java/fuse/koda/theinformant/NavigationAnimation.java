...
public class NavigationAnimation extends BottomNavigationView {
    ...
    public NavigationAnimation(Context context) {
        super(context);
        init();
    }

    public NavigationAnimation(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public NavigationAnimation(Context context, AttributeSet attrs, int defStyleAttr) {
